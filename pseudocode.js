...
// create app variable pointing to new express object
...
// /api/notes
//   get request to fetch all notes, routes: '/api/notes'
//   post request to save a note, routes: '/api/notes'
//   delete request to delete specific note, route: '/api/notes/:note_id'
//      req.params.note_id
